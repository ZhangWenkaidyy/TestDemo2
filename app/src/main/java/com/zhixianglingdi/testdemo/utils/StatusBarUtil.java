 ...
 *
 * 项目名称：Calendarview
 * 类描述：com.hx.hx_landmark.close_to_travel
 * 创建人：kevin
 * 创建时间：2017/10/13
 * 修改人：kevin
 * 修改时间：
...
public class StatusBarUtil {
     ...
     * 设置状态栏颜色
     *
     * @param bDark    true 字体颜色为黑 false字体颜色为白色
     * @param activity
     */
    public static void setDarkStatusIcon(boolean bDark, Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
